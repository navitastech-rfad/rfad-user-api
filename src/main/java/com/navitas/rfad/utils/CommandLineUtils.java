...
public class CommandLineUtils implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        personRoleRepository.saveAll(
                Arrays.asList(createPersonRole(admin1.getId(), "admin"), createPersonRole(user1.getId(), "user")));
    }

    private Person createPerson(String email, String password, String firstName, String lastName, String roleCode) {
